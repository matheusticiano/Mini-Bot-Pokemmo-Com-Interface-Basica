...
X_SPOT = 801  # Cordenadas do spot
Y_SPOT = 451  # Cordenadas do spot
...
contador = 1  # Numeros de pps do ataque do seu pokemon (começa em 1 para caso curar seu pokemon em casos que não esteja completo)
...
def voltar_spot():  # Função que simula a ação de voltar ao local de pesca
    sleep(0.2)
    pyautogui.keyDown('s')
    sleep(3)
    pyautogui.keyUp('s')
...
def set_spot():  # Função que simula a ação de salvar o teleport e ir para spot do local
    sleep(0.5)
    pyautogui.moveTo(X_SPOT, Y_SPOT)
    sleep(0.2)
    pyautogui.click(X_SPOT, Y_SPOT)
    sleep(0.5)
    pyautogui.click(X_SPOT, Y_SPOT)
    sleep(5)
    pyautogui.keyDown('w')
...
def checa_mapa_e_define_spot():  # Função que simula a ação de conferir em qual região o player está e leva-lo para o spot da farm
